...
//this code originates from <http://www.vogella.com/tutorials/JavaAlgorithmsDijkstra/article.html>
...
public class DijkstraAlgorithm {
  ...
  private double getDistance(Vertex node, Vertex target) {
    for (Edge edge : edges) {
      if (edge.getSource().equals(node)
        ...
        return edge.getWeight();  // may we have an error here!
      }
  ...
  private ArrayList<Vertex> getNeighbors(Vertex node) {
    ...
    for (Edge edge : edges) {
      ...
      else if (edge.getDestination().equals(node)// may we have an error here!
